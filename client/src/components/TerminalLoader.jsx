    ...
    const interval = setInterval(() => {
      setProgress((prev) => {
        ...
        const newPhase = Math.min(
          Math.floor((prev / 100) * phases.length),
          phases.length - 1
        );
  ...
  return (
    ...
    >
      <div className='w-full max-w-2xl p-8'>
        {/* Terminal container */}
        <div className='rounded-lg overflow-hidden backdrop-blur-sm border border-dusk bg-neutral-50'>
          {/* Terminal header */}
          ...
          <div className='p-6 space-y-4 text-text-primary'>
            {/* ASCII Art - HALLO in German */}
            <div className='text-ok-400 mb-6'>
...
`}
            ...
            <div className='space-y-1 mb-6'>
              {systemInfo.map((item, i) => (
                ...
                >
                  <span className='w-12 text-lagoon'>{item.label}</span>
            ...
            {/* Typing log */}
            <div className='h-32 overflow-hidden text-xs mb-4 font-mono leading-relaxed text-neutral-500'>
              ...
              <motion.span
                ...
                className='inline-block w-2 h-4 align-middle ml-1 bg-lagoon'
              />
            </div>
            ...
            <div className='space-y-2 mb-4'>
              {phases.slice(0, loadingPhase + 1).map((phase, i) => (
                ...
                >
                  ...
                  <span
                    className={
                      i === loadingPhase ? 'text-lagoon' : 'text-neutral-500'
                    }
                  >
                    {phase}
                  </span>
