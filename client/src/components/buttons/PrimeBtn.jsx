...
import PrimeBtnGradient from './PrimeBtnGradient.jsx';
...
const PrimeBtn = ({
  ...
  const baseClasses = useMemo(
    () =>
      `button relative inline-flex items-center justify-center font-dune rounded-full ${px} ${
  ...
  const renderContent = () => (
    <>
      ...
      <PrimeBtnGradient white={white} outline={isOutline} />
    </>
  );
...
PrimeBtn.propTypes = {
  ...
  px: PropTypes.string, // Padding classes
